export class MyButton{
    ...
    render()
    {
        ...
        document.getElementById("root").appendChild(btn)//we don't use innerHTML because it will remove the heading on root, so we append a child, we give it a child underneath.
    }
}